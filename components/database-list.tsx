                                ...
                                {uploads.map((upload) => {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            className="group flex items-center justify-between p-4 hover:bg-slate-50 transition-all cursor-pointer border-l-4 border-transparent hover:border-accent active:bg-slate-100"
                                        >
